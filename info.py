...
PICS = (environ.get('PICS', 'https://graph.org/file/9b9019401b65ac5478d17-0b7e4b276ec37f83ce.jpg https://graph.org/file/8b89c9428d5fba1636475-c83e369419edbbdca6.jpg')).split() 
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003326626023'))  
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://DQ_DB1:DQ_DB11@cluster0.1pxwbbu.mongodb.net/?appName=Cluster0")
...
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1003363230006')
...
MSG_ALRT = environ.get('MSG_ALRT', '𝑯𝒂𝒊𝒊𝒊 ♥️')
